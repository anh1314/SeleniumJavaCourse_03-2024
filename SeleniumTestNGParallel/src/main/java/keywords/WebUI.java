...
public class WebUI {
    private static int TIMEOUT = 10;    //chờ WebDriverWait
    private static double STEP_TIME = 0.5;  // chờ sleep
    private static int PAGE_LOAD_TIMEOUT = 30;  // chờ trang load
    ...
    //open URL
    @Step("Open URL: {0}")  //{0} lấy giá trị tham số đầu tiên
    ...
    //click Element với Duration.ofSeconds có giá trị cố định
    ...
    //click Element với  Duration.ofSeconds là giá trị có thể thay đổi (truyền vào second)
    @Step("Click on element {0} with timeout {1}")
    public static void clickElement(By by, int second){
       waitForElementClickable(by, second);
        getWebElement(by).click();
        logConsole("Click on element  " +by+ "with timeout is" + second + "seconds");
        ExtentTestManager.logMessage(Status.INFO, "Click on element  " +by+ "with timeout is" + second + "seconds");
    }
    ...
    // sendKeys element với  Duration.ofSeconds là giá trị có thể thay đổi (truyền vào second)
    ...
    public static void setText(By by, String text, int second){
        ...
        getWebElement(by).sendKeys(text);
        logConsole("Set text " + text + " on input " + by + "with timeout is " + second + " seconds");
        ExtentTestManager.logMessage(Status.INFO, "Set text " + text + " on input " +by+ "with timeout is " + second + " seconds");
    }

    //getText element
    @Step("Get text of elemet  {0}")
    public static String getElementText(By by) {
       waitForElementVisible(by);
        String text = DriverManager.getDriver().findElement(by).getText();
        logConsole("Get text of elemet " +by+ " is: " + text);
        ExtentTestManager.logMessage(Status.INFO, "Get text of elemet " +by+ " is: " + text );
        AllureManager.saveTextLog("==> " +text); //ghi thêm text log ở @Step
    ...
    // hoverElement: di chuyển chuột đến vị trí element
    ...
    //Wait for Element  với  Duration.ofSeconds là giá trị có thể thay đổi (truyền vào timeOut)
    ...
    //waitForElementPresent với Duration.ofSeconds là giá trị có thể thay đổi (truyền vào timeOut)
    ...
    //waitForElementClickable với Duration.ofSeconds là giá trị có thể thay đổi (truyền vào timeOut)
    ...
    public static void waitForElementNotVisible(By by) {
        try {
            ...
            LogUtils.error("Timeout waiting for the element ready NOT visible. " + by.toString());
