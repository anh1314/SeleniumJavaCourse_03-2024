...
public class CustomerPage {
    ...
    private String headerCustomerText = "Customers Summary";
    //Customers List
    private By headerCustomerPage = By.xpath("//span[normalize-space()='Customers Summary']");
    private By menuCustomers = By.xpath("//a[@href='https://crm.anhtester.com/admin/clients']");
...
//        wait = new WebDriverWait(driver, Duration.ofSeconds(5));
        new WebUI(driver);  //bắt buộc phải khởi tạo để truyền driver vào
    }
    public void verifyHeaderCustomerPage(){
      WebUI.waitForElementVisible(headerCustomerPage);
        Assert.assertTrue(WebUI.checkElementDisplayed(headerCustomerPage), "header not display");
        Assert.assertEquals(WebUI.getElementText(headerCustomerPage), headerCustomerText, "Content of customer page not match");
    }
